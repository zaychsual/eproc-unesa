                                    ...
                                    <div class="panel-body">
                                        <p>
                                            ...
                                            <a href="" target="_blank" class="btn btn-primary">
                                                Status : Belum Dikirim, Jadwal Pengiriman : {{ \tglindo($paketJadwal->dok_penawaran_mulai) }} &nbsp; s.d &nbsp;
                                                    {{ \tglindo($paketJadwal->dok_penawaran_selesai) }}
                                            </a>
                                            @endif
                                        </p>
                                    </div>
                            ...
                            <td>
                                ...
                                <div class="panel-heading">Status Pengiriman Dokumen</div>
                                    <div class="panel-body">
                                        ...
                                        @if($buttons == 'show')
                                        <p class="pull-right">
                                            <a class="btn btn-rounded btn-info" href="{{ route('penawaran.input-penawaran', \Crypt::encrypt($paket->id)) }}">Kirim Penawaran</a>
                                        </p>
                                        @endif
                                    </div>
                                </div>
