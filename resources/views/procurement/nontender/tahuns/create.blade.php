...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('tahuns.store'), 'method' => 'POST', 'id' => 'tahaps', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
               ...
               <div class="form-group @if ($errors->has('tahun')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('tahun', old('tahun'), array('class' => 'form-control', 'required')) }}
                        </div>  
                            @if ($errors->has('tahun'))
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/tahuns')}}" class="btn btn-default pull-left">Batal</a>                               
