...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::model($data, ['route' => ['kualifikasis.update', $data->id], 'method'=>'patch', 'class'=>'form-horizontal']) !!}
        {!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/kualifikasi')}}" class="btn btn-default pull-left">Batal</a>                               
