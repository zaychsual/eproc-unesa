@extends('procurement.layouts.backend.app')
...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('tahaps.store'), 'method' => 'POST', 'id' => 'tahaps', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('keterangan')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::textarea('keterangan', old('keterangan'), array('class' => 'form-control' , 'required')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('urut')) has-error @endif">
                    <label class="col-md-3 col-xs-12 control-label">Urutan *</label>
                    <div class="col-md-6 col-xs-12">                                            
                        {{ Form::number('urut', old('urut'), array('class' => 'form-control', 'required')) }}
                            @if ($errors->has('urut'))
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/tahaps')}}" class="btn btn-default pull-left">Batal</a>                               
