            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group @if ($errors->has('category_id')) has-error @endif">
                        ...
                        <div class="col-md-6 col-xs-12">                                              
                            {{ Form::select('category_id', $data['category'], '11cd7802-0e6f-11eb-adc1-0242ac120002', ['class' => 'form-control category_id', 'data-live-search' => 'true', 'style' => 'width: 100%;', 'id' => 'category_id', 'placeholder' => '- Pilih Data -', 'required']) }}
