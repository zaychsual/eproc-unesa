        ...
        $("#add_hps").click(function() {
            let htmlHps = `
                    <tr data-id="${indexHps}">
                        ...
                        <td>
                            {{ Form::number('qty[]', old('qty'), array('id' => 'qty_${indexHps}', 'required')) }}
                        </td>
                        <td>
                            {{ Form::number('harga[]', old('harga'), array('id' => 'harga_${indexHps}', 'required')) }}
                        </td>
                        <td>
                            {{ Form::number('pajak[]', old('pajak'), array('id' => 'pajak_${indexHps}', 'required')) }}
                        </td>
                        <td>
