            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group @if ($errors->has('category_id')) has-error @endif">
                        ...
                        <div class="col-md-6 col-xs-12">                                              
                            {{ Form::select('category_id', $data['category'], 'd0d01864-0e6e-11eb-adc1-0242ac120002', ['class' => 'form-control category_id', 'data-live-search' => 'true', 'style' => 'width: 100%;', 'id' => 'category_id', 'placeholder' => '- Pilih Data -', 'required']) }}
...
{{-- 
                    ...
                    <div class="form-group @if ($errors->has('link_pembelian')) has-error @endif">
                        <label class="col-md-3 col-xs-12 control-label"><b>Link Pembelian</b></label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                {{ Form::text('link_pembelian', old('link_pembelian'), array('class' => 'form-control', 'id'=>'link_pembelian', 'required')) }}
                            </div> 
                                @if ($errors->has('link_pembelian'))
                                <span class="help-block">{{$errors->first('link_pembelian')}}</span>
                                @endif                                           
                        </div>
                    </div>
