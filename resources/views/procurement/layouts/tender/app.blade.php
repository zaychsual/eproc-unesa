...
<head>        
    ...
    <body class="page-container" style="margin-bottom: 29px;">
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal">
                    @if(Auth::user()->role == 'pokja')
                        @include('procurement.layouts.tender.navigations.app.pokja')
                    @endif
                    @if(Auth::user()->role == 'pejabatpengadaan')
                        @include('procurement.layouts.tender.navigations.app.pejabatpengadaan')
                    @endif
                    @if(Auth::user()->role == 'laman')
                        @include('procurement.layouts.tender.navigations.app.laman')
                    @endif
                    @if(Auth::user()->role == 'kaukpbj')
                        @include('procurement.layouts.tender.navigations.app.ukpbj')
                    @endif
                    @if(Auth::user()->role == 'ppk')
                        @include('procurement.layouts.tender.navigations.app.ppk')
                    @endif
                    @if(Auth::user()->role == 'pengendalikualitas')
                        @include('procurement.layouts.tender.navigations.app.pengendalikualitas')
                    @endif
                </ul>
                ...
                <div class="page-content-wrap">   
                    @include('procurement.layouts.tender.partials.alert')
                    @include('procurement.layouts.tender.partials.validation')
                    @yield('content')             
