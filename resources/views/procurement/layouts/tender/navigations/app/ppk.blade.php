...
<li class="xn-openable">
    <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Daftar Paket</span></a>
    <ul class="animated zoomIn">
        <li class="{{ Request::is('procurement/pakets') ? 'active' : '' }}"><a href="{{URL::to('procurement/pakets')}}"><span class="fa fa-image"></span> List Paket</a></li>
...
<li class="xn-openable {{ Request::is('procurement/user') ? 'active' : '' }}">
    <a href="{{URL::to('procurement/user')}}"><span class="fa fa-pencil"></span> <span class="xn-text">Ganti Password</span></a>
</li> -->
