                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a id="pilih" style="display:none" class="btn btn-success" href="{{ route('epurchasing.create-rekanan', Crypt::encrypt($paket['id'])) }}">
                                <i class="fa fa-arrow-down"></i>
                                Pilih penyedia
                            </a>
                            <a id="input" style="display:none" class="btn btn-success" href="{{ route('epurchasing.create-rekanan-input', Crypt::encrypt($paket['id'])) }}">
                                <i class="fa fa-arrow-down"></i>
                                Input penyedia
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($bap == null)
                            <a href="{{ route('epurchasing.create-ba-negoisasi', Crypt::encrypt($paket['id'])) }}" class="btn btn-warning">
                                Buat BA Negoisasi
                            </a>
                            @else 
                            <a href="{{ route('epurchasing.print-ba-negoisasi', $bap->id) }}" class="btn btn-danger" target="_blank">
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('epurchasing.store-undangan') }}" method="post">
                @csrf
