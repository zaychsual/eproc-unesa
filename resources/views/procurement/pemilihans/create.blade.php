...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('pemilihans.store'), 'method' => 'POST', 'id' => 'tahaps', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <div class="form-group @if ($errors->has('pemilihan')) has-error @endif">
                    <label class="col-md-3 col-xs-12 control-label">Pemilihan *</label>
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('pemilihan', old('pemilihan'), array('class' => 'form-control', 'required')) }}
                        </div>  
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/pemilihans')}}" class="btn btn-default pull-left">Batal</a>                               
