    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a class="btn btn-info" href="{{URL::to('procurement/evaluasis/create')}}" style="margin: 0cm 0px 0cm 10px;">Tambah</a>
                    ...
                    @foreach($data as $value)
                        <tr style="cursor:pointer">
                            ...
                            <td style="text-align:center;">
                                ...
                                <a href="{{ route('evaluasis.edit', ['data'=>Crypt::encrypt($value->id)]) }}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>

                                <button class="btn btn-danger btn-xs" id="btn_delete" data-file="{{$value->id}}"><i class="fa fa-trash-o"></i></button>
                                {{ Form::open(['url'=>route('evaluasis.destroy', ['data'=>Crypt::encrypt($value->id)]), 'method'=>'delete', 'id' => $value->id, 'style' => 'display: none;']) }}
                                {{ csrf_field() }}
                                {{ Form::close() }}
                              </td>
                           <?php $no++;?>
