	...
	<div class="col-md-12">
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
                <form action="{{ route('penunjukan-langsung.store-kualifikasi') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <table>
                            @foreach($mkualfikasi as $key => $value)
                            <tr>
                                <td>
                                    <input type="checkbox" name="mt_kualifikasi_id[]" value="{{ $value->id }}">
                                </td>
                                <td>
                                    &nbsp; {{ $value->nama }}
                                </td>
