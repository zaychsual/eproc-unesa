        ...
        <div class="col-md-12">
            <div class="panel with-nav-tabs panel-primary">
                ...
                <div class="panel-body">
                    <form action="{{ route('penunjukan-langsung.store-evaluasi') }}" method="post">
                        @csrf
                            ...
                            <div class="tab-pane fade in active" id="tab1administrasi">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_doc_type_administrasi[]" value="1">
                                            <input type="checkbox" name="memenuhi_administrasi[]" value="1">
                                            <input type="hidden" name="mt_dokumen_penawran_id[]" value="{{ $value->mt_dokumen_penawaran_id }}">
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
                            ...
                            <div class="tab-pane fade" id="tab2kualifikasi">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="is_doc_type_kualifikasi[]" value="2">
                                            <input type="checkbox" name="memenuhi_kualifikasi[]" value="1">
                                            <input type="hidden" name="mt_kualifikasi_id[]" value="{{ $rows->mt_kualifikasi_id }}">
                                        </td>
                                    </tr>
                                    @endforeach
                                </table>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($paketDok as $key => $value)
                                        ...
                                        <tr>
                                            <td colspan=10>{{ $value->name }}</td>
                                            <td>
                                                <input type="hidden" name="is_doc_type_teknis[]" value="3">
                                 ...
                                 <table class="table table-bordered">
                                    ...
                                    @foreach($paketDok as $key => $value)
                                        ...
                                        <tr>
                                            <td colspan=10>{{ $value->name }}</td>
                                            <td>
                                                <input type="hidden" name="is_doc_type_harga[]" value="4">
