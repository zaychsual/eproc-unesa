    ...
    <div class="panel with-nav-tabs panel-primary">
        <div class="panel-heading">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tabKualifikasi" data-toggle="tab">Kualifikasi</a></li>
                @if(!empty($getTahapan))
        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tabInfoPaket">
                    @include('procurement.tenderpra.kualifikasi.tab-infopaket')
                </div>
                @if(!empty($getTahapan))
                    @if($getTahapan->nama == 'Debriefing')
                    <div class="tab-pane fade" id="tabDbriefing">
                        @include('procurement.tenderpra.kualifikasi.tab-briefing')
                    </div>
                    @endif
                @endif
            </div>
