...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('dokumens.store'), 'method' => 'POST', 'id' => 'tahaps', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
               ...
               <div class="form-group @if ($errors->has('dokumen')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('dokumen', old('dokumen'), array('class' => 'form-control', 'required')) }}
                        </div>  
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/dokumens')}}" class="btn btn-default pull-left">Batal</a>                               
