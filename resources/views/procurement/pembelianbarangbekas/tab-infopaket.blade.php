                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a id="pilih" style="display:none" class="btn btn-success" href="{{ route('pembelian-barang-bekas.create-rekanan', Crypt::encrypt($paket['id'])) }}">
                                <i class="fa fa-arrow-down"></i>
                                Pilih penyedia
                            </a>
                            <a id="input" style="display:none" class="btn btn-success" href="{{ route('pembelian-barang-bekas.create-rekanan-input', Crypt::encrypt($paket['id'])) }}">
                                <i class="fa fa-arrow-down"></i>
                                Input penyedia
                            </a>
                            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                $klarifikasi = \App\Models\Procurement\Eklarifikasi::where('paket_id', $paket->id)->first();   
                            @endphp
                            @if($klarifikasi == null)
                            <a href="{{ route('pembelian-barang-bekas.create-klarifikasi', Crypt::encrypt($paket['id'])) }}" class="btn btn-warning">
                                Buat Klarifikasi
                            </a>
                            @else 
                            <a href="{{ route('pembelian-barang-bekas.view-klarifikasi', Crypt::encrypt($paket['id'])) }}" class="btn btn-warning">
                                Lihat Klarifikasi
                            </a>
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($bap == null)
                            <a href="{{ route('pembelian-barang-bekas.create-ba-negoisasi', Crypt::encrypt($paket['id'])) }}" class="btn btn-warning">
                                Buat BA Negoisasi
                            </a>
                            @else 
                            <a href="{{ route('pembelian-barang-bekas.print-ba-negoisasi', $bap->id) }}" class="btn btn-danger" target="_blank">
                                <i class="fa fa-print"></i>Print BA Negoisasi
                            </a>
                            @endif
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <a href="{{ route('pembelian-barang-bekas.create-surat-pesanan', Crypt::encrypt($paket['id'])) }}" class="btn btn-info">
                                Buat Surat Pesanan
                            </a>
                        </td>
                    </tr>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('pembelian-barang-bekas.store-undangan') }}" method="post">
                @csrf
