...
<div class="row">
    <div class="col-md-12">
        ...
        {!! Form::model($data, ['route' => ['satuankerjas.update', $data->id], 'method'=>'patch', 'class'=>'form-horizontal']) !!}
        {!! csrf_field() !!}
        ...
        <div class="panel panel-default">
              ...
              <div class="form-group @if ($errors->has('satuankerja')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('satuankerja', old('satuankerja'), array('class' => 'form-control', 'required')) }}
                        </div>  
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('tenders/satuankerja')}}" class="btn btn-default pull-left">Batal</a>                               
