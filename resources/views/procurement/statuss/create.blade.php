...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('statuss.store'), 'method' => 'POST', 'id' => 'statuss', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('procurement/statuss')}}" class="btn btn-default pull-left">Batal</a>                               
