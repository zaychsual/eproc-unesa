...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('ijinusahas.store'), 'method' => 'POST', 'id' => 'ijinusahas', 'files' => true, 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
	        ...
	        <div class="panel-body">
	            ...
	            <div class="form-group @if ($errors->has('jenis_ijin')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('jenis_ijin', old('jenis_ijin'), array('class' => 'form-control', 'required')) }}
                        </div>  
                ...
                <div class="form-group @if ($errors->has('nomor_surat')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('nomor_surat', old('nomor_surat'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('berlaku_sampai')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                              
                        {{ Form::select('berlaku_sampai', array('Tanggal' => 'Tanggal', 'Seumur Hidup' => 'Seumur Hidup'), old('berlaku_sampai'), ['class' => 'form-control berlaku_sampai', 'style' => 'width: 100%;', 'id' => 'berlaku_sampai', 'placeholder' => 'Pilih Satuan', 'required']) }}
                ...
                <div class="form-group @if ($errors->has('kualifikasi')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                              
                        {{ Form::select('kualifikasi', array('Perusahaan Kecil' => 'Perusahaan Kecil', 'Perusahaan Non Kecil' => 'Perusahaan Non Kecil'), old('kualifikasi'), ['class' => 'form-control kualifikasi', 'style' => 'width: 100%;', 'id' => 'kualifikasi', 'placeholder' => 'Pilih Kualifikasi', 'required']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">  
                        {{ Form::file('link_file', array('class'=>'fileinput btn-primary', 'id'=>'file-simple', 'data-filename-placement'=>'inside', 'title'=>'Browse file')) }}                                   
