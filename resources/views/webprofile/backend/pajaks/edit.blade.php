...
<div class="row">
    <div class="col-md-12">
      ...
      {!! Form::model($data, ['route' => ['pajaks.update', $data->id], 'method'=>'patch', 'files' => true, 'class'=>'form-horizontal']) !!}
      {!! csrf_field() !!}
            ...
            <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('jenis')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('jenis', old('jenis'), array('class' => 'form-control', 'required')) }}
                        </div>  
                            @if ($errors->has('jenis'))
                ...
                <div class="form-group @if ($errors->has('masa_pajak_tahun')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('masa_pajak_tahun', old('masa_pajak_tahun'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('nomor_bukti')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('nomor_bukti', old('nomor_bukti'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            {{ Form::text('tanggal_bukti', date('Y-m-d'), array('class' => 'form-control datepicker', 'required')) }}                                            
                        </div>
