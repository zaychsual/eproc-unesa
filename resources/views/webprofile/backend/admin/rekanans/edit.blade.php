...
$data_jenis_pengadaan = ['Konstruksi', 'Barang', 'Jasa Konstruksi', 'Jasa Lain'];

if(!isset($rekanan['jenis_pengadaan']))
{}
else {
	$jenis_pengadaan = explode(',', $rekanan['jenis_pengadaan']);
}
?>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							{{ Form::select('kota_id', $data['kota'], old('kota_id'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'kota_id', 'placeholder' => '- Pilih Data -', 'required']) }}
					...
					<div class="form-group @if ($errors->has('jenis_pengadaan')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12">                                              
							{{ Form::select('mt_jenis_pengadaan_id', $data['jenispengadaans'], old('mt_jenis_pengadaan_id'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'jenispengadaans', 'placeholder' => '- Pilih Data -', 'required']) }}
...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-footer">
			{{-- <a href="{{URL::to('webprofile/pemiliks')}}" class="btn btn-default pull-right">Batal</a> --}}
