...
<div class="row">
<div class="col-md-12">
	{!! Form::open(array('url' => route('rekanans.store'), 'method' => 'POST', 'id' => 'rekanans', 'class' => 'form-horizontal')) !!}
	{!! csrf_field() !!}
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group @if ($errors->has('bentuk_usaha')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12">                                              
							{{ Form::select('bentuk_usaha', $data['bentuk_usaha'], old('bentuk_usaha'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'bentuk_usaha', 'placeholder' => '- Pilih Data -', 'required']) }}
					...
					<div class="form-group @if ($errors->has('provinsi_id')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12">
							{{ Form::select('provinsi_id', $data['provinsi'], old('provinsi_id'), ['class' => 'form-control select', 'data-live-search' => 'true', 'style' => 'width: 100%;', 'id' => 'provinsi_id', 'placeholder' => '- Pilih Data -', 'required']) }}
					...
					<div class="form-group @if ($errors->has('kota_id')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12">
								{{ Form::select('kota_id', [], old('kota_id'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'kota_id', 'placeholder' => '- Pilih Data -', 'required']) }}
					...
					<div class="form-group @if ($errors->has('is_kantor_cabang')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12"> 
							{{ Form::select('is_kantor_cabang', array('TIDAK' => 'Tidak', 'YA' => 'Ya'), old('is_kantor_cabang'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'is_kantor_cabang', 'placeholder' => '- Pilih Data -', 'required']) }}
				...
				<div class="col-md-6">
					...
					<div class="form-group @if ($errors->has('jenis_pengadaan')) has-error @endif">
						...
						<div class="col-md-9 col-xs-12">                                            
							<div class="input-group">
								<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                {{ Form::select('jenis_pengadaan[]', array('Konstruksi' => 'Konstruksi', 'Barang' => 'Barang', 'Jasa Konstruksi' => 'Jasa Konstruksi', 'Jasa Lain' => 'Jasa Lain'), old('jenis_kelamin'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'jenis_pengadaan', 'required', 'multiple' => 'multiple']) }}
							</div>  
								@if ($errors->has('website'))
								<span class="help-block">{{$errors->first('website')}}</span>
								@endif                                          
