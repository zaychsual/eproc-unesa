            ...
            <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('nilai_kontrak')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('nilai_kontrak', old('nilai_kontrak'), array('class' => 'form-control', 'id'=>'nilai_kontrak')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('persen_pelaksanaan')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('persen_pelaksanaan', old('persen_pelaksanaan'), array('class' => 'form-control', 'id'=>'persen_pelaksanaan')) }}
                        </div> 
