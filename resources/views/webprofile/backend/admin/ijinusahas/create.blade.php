...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('method' => 'POST', 'id' => 'ffijinusahas', 'files' => true, 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
...
<script type="text/javascript">
    $('#ffijinusahas').on('submit', function(event){
        event.preventDefault();
        $.ajax({
            url:"{{ route('ijinusahas.store') }}",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                if(data.success)
                {
                    swal({ 
                        ...
                        function(){
                            window.parent.loadFrameIjinUsaha();
