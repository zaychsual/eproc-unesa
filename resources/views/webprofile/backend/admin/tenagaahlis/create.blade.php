...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('tenagaahlis.store'), 'method' => 'POST', 'id' => 'fftenagaahlis', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group @if ($errors->has('jenis_kelamin')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                              
                                {{ Form::select('jenis_kelamin', array('Pria' => 'Pria', 'Wanita' => 'Wanita'), old('jenis_kelamin'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'jenis_kelamin', 'placeholder' => 'Pilih', 'required']) }}
                        ...
                        <div class="form-group @if ($errors->has('pengalaman_kerja')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                            
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    {{ Form::text('pengalaman_kerja', old('pengalaman_kerja'), array('class' => 'form-control', 'id' => 'pengalaman_kerja')) }}
                                </div> 
                        ...
                        <div class="form-group @if ($errors->has('status_kepegawaian')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                              
                                {{ Form::select('status_kepegawaian', array('Tetap' => 'Tetap', 'Tidak Tetap' => 'Tidak Tetap'), old('status_kepegawaian'), ['class' => 'form-control select', 'style' => 'width: 100%;', 'id' => 'status_kepegawaian', 'placeholder' => 'Pilih', 'required']) }}
...
<script type="text/javascript">
    ...
    {
        $(function () {
            $.get("{{URL::to('webprofile/pengalaman')}}", function (data) {
                $("#tbDataPengalaman").append(data);
            });
        });
    }
    ...
    {
        $(function () {
            $.get("{{URL::to('webprofile/pendidikan')}}", function (data) {
                $("#tbDataPendidikan").append(data);
            });
        });
    }
    function createRowSertifikat()
    {
        $(function () {
            $.get("{{URL::to('webprofile/sertifikat')}}", function (data) {
                $("#tbDataSertifikat").append(data);
            });
        });
    }
    function createRowBahasa()
    {
        $(function () {
            $.get("{{URL::to('webprofile/bahasa')}}", function (data) {
                $("#tbDataBahasa").append(data);
            });
        });
    }

    $('#fftenagaahlis').on('submit', function(event){
        event.preventDefault();
        $.ajax({
            url:"{{ route('tenagaahlis.store') }}",
            method:"POST",
            ...
            success:function(data)
            {
                ...
                if(data.success)
                {
                    swal({ 
                        ...
                        function(){
                            window.parent.loadFrameTenagaAhli();
