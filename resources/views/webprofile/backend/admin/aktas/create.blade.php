...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('aktas.store'), 'method' => 'POST', 'id' => 'ffaktas', 'files' => true, 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">     
                <a href="{{URL::to('rekanan/aktas')}}" class="btn btn-default pull-left">Batal</a>                               
...
<script type="text/javascript">
    $('#ffaktas').on('submit', function(event){
        event.preventDefault();
        $.ajax({
            url:"{{ route('aktas.store') }}",
            method:"POST",
