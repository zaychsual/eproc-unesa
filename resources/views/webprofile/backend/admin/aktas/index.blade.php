    ...
    <div class="col-md-12">
        <div class="content-frame-top">
          <div class="page-title">
              <h3><span class="fa fa-users"></span> Akta </h3>
          </div>                        
        </div>
            ...
            <div class="panel-heading">
                ...
                @foreach($data as $value)
                    <?php if($value->is_terisi == 1){?>
                      <a class="btn btn-info" onclick="window.parent.openPopup('{{ route('aktas.edit', ['data'=>Crypt::encrypt($value->id)]) }}')" style="margin: 0cm 0px 0cm 10px;">Edit</a>
                    <?php } ?>
                @endforeach
                <?php } else{ ?>
                      <a class="btn btn-info" onclick="window.parent.openPopup('{{URL::to('rekanan/aktas/create')}}')" style="margin: 0cm 0px 0cm 10px;">Create</a>
                <?php } ?>
