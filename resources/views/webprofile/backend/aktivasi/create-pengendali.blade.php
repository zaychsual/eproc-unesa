...
<div class="row">
<div class="col-md-12">
	{!! Form::open(array('url' => route('aktivasi-pengendali-kualitas.store'), 'method' => 'POST', 'id' => 'ppk', 'class' => 'form-horizontal','enctype="multipart/form-data"')) !!}
	{!! csrf_field() !!}

	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title"><strong>Pendaftaran</strong> Pengendali Kualitas</h3>
		</div>
