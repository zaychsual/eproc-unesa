...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('peralatans.store'), 'method' => 'POST', 'id' => 'peralatans', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
	        ...
	        <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('jumlah')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('jumlah', old('jumlah'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('tahun_pembuatan')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::number('tahun_pembuatan', old('tahun_pembuatan'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group @if ($errors->has('kondisi')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                              
                        {{ Form::select('kondisi', array('Baik' => 'Baik', 'Rusak' => 'Rusak'), old('kondisi'), ['class' => 'form-control kondisi', 'style' => 'width: 100%;', 'id' => 'kondisi', 'placeholder' => 'Pilih Satuan', 'required']) }}
                ...
                <div class="form-group @if ($errors->has('status_kepemilikan')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                              
                        {{ Form::select('status_kepemilikan', $status_miliks, old('status_kepemilikan'), ['class' => 'form-control status_kepemilikan', 'style' => 'width: 100%;', 'id' => 'status_kepemilikan', 'placeholder' => 'Pilih Satuan', 'required']) }}
