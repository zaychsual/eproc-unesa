...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info push-down-20">
                    <span style="color: #FFF500;">ATENTION!</span> Untuk upload berkas dokumen tunggu sampai proses selesai.
      ...
      {!! Form::model($data, ['route' => ['aktas.update', $data->id], 'method'=>'patch', 'files' => true, 'class'=>'form-horizontal']) !!}
      {!! csrf_field() !!}
            ...
            <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('pendirian_nomor')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            ...
                            {{ Form::text('pendirian_nomor', old('pendirian_nomor'), array('class' => 'form-control', 'required')) }}
                        </div>  
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            {{ Form::text('pendirian_tanggal', date('Y-m-d'), array('class' => 'form-control datepicker', 'required')) }}                                            
                        </div>
                ...
                <div class="form-group @if ($errors->has('pendirian_notaris')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('pendirian_notaris', old('pendirian_notaris'), array('class' => 'form-control', 'required')) }}
                        </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">  
                        ...
                        <hr>
                        <div class="form-group">
                              @if($data->pendirian_link_file)
                              <a href="{{URL::to('https://statik.unesa.ac.id/profileunesa_konten_statik/uploads/'. Session::get('ss_setting')['statik_konten'] .'/aktas/'.$data->pendirian_link_file)}}" target="_blank">Lihat file yang sudah tersimpan</a><br>
                              @else
                ...
                <hr>
                <label>Akta Perubahan Terakhir</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">  
                        ...
                        <hr>
                        <div class="form-group">
                              @if($data->perubahan_link_file)
                              <a href="{{URL::to('https://statik.unesa.ac.id/profileunesa_konten_statik/uploads/'. Session::get('ss_setting')['statik_konten'] .'/aktas/'.$data->perubahan_link_file)}}" target="_blank">Lihat file yang sudah tersimpan</a><br>
                              @else
                              <img id="uploadPreview" style="width: 50px; height: 100%;" src="{{ asset('ress/img/files-icon.png') }}"/><br>
                              @endif
                        </div> 
