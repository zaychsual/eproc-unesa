...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('tenagaahlis.store'), 'method' => 'POST', 'id' => 'tenagaahlis', 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">                                        
                            ...
                            <div class="col-md-9 col-xs-12">
                                <div class="input-group">
                                    ...
                                    {{ Form::text('tanggal_lahir', date('Y-m-d'), array('class' => 'form-control datepicker', 'required')) }}                                            
                                </div>
                        ...
                        <div class="form-group @if ($errors->has('pendidikan_terakhir')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                            
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    {{ Form::text('pendidikan_terakhir', old('pendidikan_terakhir'), array('class' => 'form-control', 'required')) }}
                                </div> 
                        ...
                        <div class="form-group @if ($errors->has('keahlian')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                            
                                {{ Form::textarea('keahlian', old('keahlian'), array('class' => 'form-control', 'required')) }}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group @if ($errors->has('pengalaman_kerja')) has-error @endif">
                            ...
                            <div class="col-md-9 col-xs-12">                                            
                                <div class="input-group">
                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    {{ Form::text('pengalaman_kerja', old('pengalaman_kerja'), array('class' => 'form-control', 'id' => 'pengalaman_kerja', 'required')) }}
                                </div> 
...
<script type="text/javascript">
    ...
    {
        $(function () {
            $.get("{{URL::to('webprofile/pendidikans')}}", function (data) {
    ...
    {
        $(function () {
            $.get("{{URL::to('webprofile/sertifikats')}}", function (data) {
    ...
    {
        $(function () {
            $.get("{{URL::to('webprofile/bahasas')}}", function (data) {
