...
<li class="active">Show Pengendali Kualitas</li>
@stop
	...
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Detail</strong> Pengendali Kualitas</h3>
	        </div>
	            ...
	            <div class="row">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>HP</td>
                            <td>:</td>
                            <td> {{ Form::text('name', old('name',$user->nohp), array('class' => 'form-control')) }}</td>
                        </tr>
                    </table>
	            </div>
	        </div>
	...
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-footer">
                <a href="{{URL::to('webprofile/pengendali-kualitas')}}" class="btn btn-default pull-right">Batal</a>
...
<script>
    ...
    $('button#verify').on('click', function(e){
        ...
        function(isConfirm){
            if(isConfirm){
                const urlYes = "{{ route('pengendali-kualitas.validate-pengendali') }}"
