...
@section('content')
{!! Form::open(array('url' => route('user.store-unitkerja'), 'method' => 'POST', 'id' => 'user', 'class' => 'form-horizontal')) !!}
{!! csrf_field() !!}
<!-- page start-->
<div class="row">
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Tambah</strong> Unit Kerja</h3>
	        </div>
	            ...
	            <div class="row">
	                <div class="col-md-12">
	                    ...
	                    <div class="form-group @if ($errors->has('no_telp')) has-error @endif">
	                        ...
	                        <div class="col-md-10">
	                          {{ Form::number('no_telp', old('no_telp'), array('class' => 'form-control')) }}
						...
						<div class="form-group @if ($errors->has('laman')) has-error @endif">
	                        ...
	                        <div class="col-md-10">
	                          {{ Form::text('laman', old('laman'), array('class' => 'form-control')) }}
	                          @if ($errors->has('laman'))
