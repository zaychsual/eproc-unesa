...
<li class="active">Pejabat Pengadaan</li>
@stop
						...
						<tr style="cursor:pointer">
							...
							<td style="text-align: center;">
							  ...
							  <td style="text-align:center;">
								  ...
								  <a href="{{ route('pejabat-pengadaan.show', ['data'=>Crypt::encrypt($value->id)]) }}" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i></a>
