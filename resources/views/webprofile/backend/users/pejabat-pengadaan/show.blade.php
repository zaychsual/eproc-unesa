...
<li class="active">Show Pejabat Pengadaan</li>
@stop
	...
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Detail</strong> Pejabat Pengadaan</h3>
	        </div>
	...
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-footer">
                <a href="{{URL::to('webprofile/pejabat-pengadaan')}}" class="btn btn-default pull-right">Batal</a>
...
<script>
    ...
    $('button#verify').on('click', function(e){
        ...
        function(isConfirm){
            if(isConfirm){
                const urlYes = "{{ route('pejabat-pengadaan.validate-pejabat') }}"
