...
<li class="active">Ubah Gallery</li>
@stop
  	...
  	<div class="col-md-9">
  	    <div class="panel panel-default">
  	        <div class="panel-heading">
  	            <h3 class="panel-title"><strong>Ubah</strong> Gallery</h3>
  	        </div>
  	            ...
  	            <div class="row">
  	                <div class="col-md-12">
  	                    ...
  	                    <center>
                              ...
                              @if($data->images)
  	          	            	<img id="uploadPreview" style="width: 500px; height: 100%;" src="{{URL::to('https://statik.unesa.ac.id/profileunesa_konten_statik/uploads/'.Session::get('ss_setting')['statik_konten'].'/gallery/'.$data->images)}}"/><br>
                              @else
