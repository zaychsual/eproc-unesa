...
<head>        
    ...
    <body class="page-container-boxed" style="margin-bottom: 29px;">
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal">
                        ...
                        @if(Auth::user()->role == 'laman')
                          @include('webprofile.layouts.backend.navigations.app.laman')
                        @endif

                        @if(Auth::user()->role == 'verifikator')
                          @include('webprofile.layouts.backend.navigations.app.verifikator')
                        @endif
