...
<li class="xn-openable">
    ...
    <ul class="animated zoomIn">
        <li class="{{ Request::is('webprofile/rekanans') ? 'active' : '' }}"><a href="{{URL::to('webprofile/rekanans')}}"><span class="fa fa-image"></span> Data Penyedia (Non Aktif)</a></li>
        <li class="{{ Request::is('webprofile/listrekanans') ? 'active' : '' }}"><a href="{{URL::to('webprofile/listrekanans')}}"><span class="fa fa-user"></span> Data Penyedia</a></li>
