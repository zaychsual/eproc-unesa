  ...
  <div id="topbar" class="clearfix">
    <div class="container">
      ...
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
          <div class="topmenu">
              <span class="topbar-login"><i class="fa fa-user"></i> <a href="{!! url('/register') !!}">Registrasi</a></span>
              <span class="topbar-login"><i class="fa fa-user"></i> <a href="{!! url('/ppti-login') !!}">login</a></span>
    ...
    <div class="container">
      <nav class="navbar yamm navbar-default">
        <div class="navbar-header">
          ...
          <a href="{!! url('/') !!}" class="navbar-brand">VMS</a>
