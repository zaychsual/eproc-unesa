            ...
            <div class="panel-body">
                ...
                <div class="form-group @if ($errors->has('saham')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                            
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            {{ Form::text('saham', old('saham'), array('class' => 'form-control')) }}
                        </div> 
                            @if ($errors->has('saham'))
              ...
              <div class="form-group @if ($errors->has('satuan')) has-error @endif">
                    ...
                    <div class="col-md-6 col-xs-12">                                              
                        {{ Form::select('satuan', array('Lembar' => 'Lembar', 'Persen' => 'Persen'), old('satuan'), ['class' => 'form-control select satuan', 'style' => 'width: 100%;', 'id' => 'satuan', 'placeholder' => 'Pilih Satuan', 'required']) }}
