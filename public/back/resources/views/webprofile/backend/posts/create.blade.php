...
<li class="active">Tambah Data Repository</li>
@stop
                  	...
                  	<div class="col-md-12">
	                    <div class="form-group @if ($errors->has('categories')) has-error @endif" style="margin-top: 5px;">
                          <div class="col-md-12">
                            ...
                            {{ Form::select('categories', $categories, old('categories'), ['class' => 'form-control select2', 'style' => 'width: 100%;', 'id' => 'categories', 'placeholder' => 'Pilih Data', 'required']) }}
	                ...
	                <div class="col-md-12">
	                    <div class="form-group">
	                        ...
	                        <div class="col-md-12">
	                          <center>
                  	            <div class="form-group">
                  	            	{{ Form::file('thumbnail', array('class'=>'fileinput btn-danger', 'id'=>'file-simple', 'data-filename-placement'=>'inside', 'title'=>'Browse ...')) }}
                  	            </div>
	                          </center>
	                        </div>
	                    </div>
