...
<li class="active">Tambah Widget</li>
@stop

@section('content')
<!-- page start-->
<div class="row">
  {!! Form::open(array('url' => route('widget.store'), 'method' => 'POST')) !!}
  {!! csrf_field() !!}
  <div class="col-md-12">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Tambah</strong> Widget</h3>
	        </div>
	        <div class="panel-body">
	            <div class="row">
                    @if($pos == 'right')
                    {{ Form::text('name_design', 'widget_right', ['style'=>'display:none;']) }}
                    @endif
                    @if($pos == 'left')
                    {{ Form::text('name_design', 'widget_left', ['style'=>'display:none;']) }}
                    @endif
	                <div class="col-md-12">
