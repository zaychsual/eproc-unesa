	...
	<div class="col-md-9">
	    <div class="panel panel-default">
	        <div class="panel-heading">
	            <h3 class="panel-title"><strong>Tambah</strong> File</h3>
	        </div>
	            ...
	            <div class="row">
	                <div class="col-md-12">
						<div class="form-group @if ($errors->has('categories_file')) has-error @endif" style="margin-top: 5px;">
							...
							<div class="col-md-10">
								{{ Form::select('categories_file', $categoriesFile, old('categories_file'), ['class' => 'form-control select2', 'style' => 'width: 100%; font-size: 16px; height: 40px;', 'id' => 'categories_file', 'placeholder' => 'Kategori', 'required']) }}
	                    ...
	                    <div class="form-group @if ($errors->has('title')) has-error @endif">
	                        <label class="col-md-2 control-label">Nama File</label>
	                        <div class="col-md-10">
...
{!! Html::script('https://statik.unesa.ac.id/profileunesa_konten_statik/sweet/sweetalert-dev.js') !!}
{!! Html::script('js/admin/upload.js') !!}
@stop
