            ...
            <div class="panel-body">
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            {{ Form::text('tanggal_awal', old('tanggal_awal'), array('class' => 'form-control datepicker')) }}                                            
                        </div>
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                            {{ Form::text('tanggal_akhir', old('tanggal_akhir'), array('class' => 'form-control datepicker')) }}                                            
                        </div>
