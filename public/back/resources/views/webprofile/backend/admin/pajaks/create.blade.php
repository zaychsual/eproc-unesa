...
<div class="row">
	<div class="col-md-12">
		...
		{!! Form::open(array('url' => route('pajaks.store'), 'method' => 'POST', 'id' => 'ffpajaks', 'files' => true, 'class' => 'form-horizontal')) !!}
		{!! csrf_field() !!}
...
<script type="text/javascript">
    ...
    $('#ffpajaks').on('submit', function(event){
        event.preventDefault();
        $.ajax({
            url:"{{ route('pajaks.store') }}",
            method:"POST",
