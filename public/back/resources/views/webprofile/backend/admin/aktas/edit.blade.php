    ...
    {!! csrf_field() !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <span><strong>Akta Pendirian</strong></span>
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            {{ Form::text('pendirian_tanggal', old('pendirian_tanggal'), array('class' => 'form-control datepicker')) }}                                            
                        </div>
                ...
                <span><strong>Akta Perubahan Terakhir</strong></span>
                ...
                <div class="form-group">                                        
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                            {{ Form::text('perubahan_tanggal', old('perubahan_tanggal'), array('class' => 'form-control datepicker')) }}                                            
                        </div>
