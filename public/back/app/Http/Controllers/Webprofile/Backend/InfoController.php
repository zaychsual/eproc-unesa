...
class InfoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('webprofile.backend.info.index', compact('data'))->withTitle('Agenda');
    }
    ...
    {
        return view('webprofile.backend.info.create')->withTitle('Tambah Agenda');
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view('webprofile.backend.info.edit', compact('data'))->withTitle('Ubah Agenda');
        } catch (\Exception $id) {
            return redirect()->route('info.index');
        }
    }
