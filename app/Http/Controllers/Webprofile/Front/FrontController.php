...
class FrontController extends Controller
{
    ...
    public function index()
    {
        ...
        $info = Info::where('info_status', '1')->orderby('event_date', 'desc')->limit('5')->get();
    ...
    public function informasi()
    {
        ...
        return View('webprofile.front.archive', compact('data', 'categories', 'hot', 'menu', 'footer', 'widget_right', 'widget_left'))->withTitle('Informasi');
    }
