...
class AktivasiPengendaliKualitasController extends Controller
{
    ...
    {
        return view('webprofile.backend.pengendali-kualitas.create')->withTitle('Tambah Kategori');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $successmessage = "Proses Pendaftaran pengendali kualitas Berhasil !!";
            return redirect()->route('aktivasi-pengendali-kualitas.show', ['id' => $data['reqUserId']])->with('successMessage', $successmessage);
    ...
    public function show($id)
    {
        ...
        if (empty($email))
            ...
            return view('webprofile.backend.aktivasi.create-pengendali', compact('data'))->withTitle('VMS: Proses Pengisian Formulir Registrasi Pengendali kualitas Baru');
    }
