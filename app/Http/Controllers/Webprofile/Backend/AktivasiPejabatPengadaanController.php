...
class AktivasiPejabatPengadaanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('aktivasi-pejabat-pengadaan.show', ['id' => $data['reqUserId']])
            ...
            $successmessage = "Proses Pendaftaran Pejabat Pengadaan Berhasil (menunggu persetujuan admin) !!";
            return redirect()->route('aktivasi-pejabat-pengadaan.show', ['id' => $data['reqUserId']])->with('successMessage', $successmessage);
    ...
    public function show($id)
    {
        ...
        if (empty($email))
            ...
            return view('webprofile.backend.aktivasi.create-pejabat', compact('data'))->withTitle('VMS: Proses Pengisian Formulir Registrasi Pejabat Pengadaan Baru');
    }
