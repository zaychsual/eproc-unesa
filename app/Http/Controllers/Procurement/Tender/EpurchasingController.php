...
class EpurchasingController extends Controller
{
    ...
    public function create($paket_id)
    {
        ...
        return view('procurement.epurchasing.create',compact(
            'paket',
            'rekanan',
            'penawaran',
            'bap'
        ))
        ->withTitle('Epurchasing');
    }
    ...
    */
    public function createRekanan($paket_id)
    {
        ...
        return view('procurement.epurchasing.create-rekanan',compact('paket','rekanan'))->withTitle('Pilih Rekanan');
    }
    ...
    */
    public function createRekananInput($paket_id)
    {
        ...
        return view('procurement.epurchasing.create-rekanan-input',compact('paket','data','paketHps'))->withTitle('Pilih Rekanan');
    }
    ...
    */
    public function createNegoisasi($paket_id, $rekanan_id)
    {
        ...
        return view('procurement.epurchasing.create-negoisasi',compact('paket','paketHps','rekanan_id'))->withTitle('Input Negoisasi');
    }
    ...
    */
    public function createBaNegoisasi($paket_id)
    {
        ...
        return view('procurement.epurchasing.create-bap-negoisasi',compact('paket','paketRekanan'))->withTitle('Buat Berita Acara Negoisasi');
    }
    ...
    */
    ...
    public function storeBap(Request $request)
    {
        try {
            ...
            Alert::success('Data berhasil disimpan')->persistent('Ok');
            return redirect()->route('epurchasing.create',Crypt::encrypt($request->paket_id));
        } catch (\Throwable $th) {
            throw $th;
        }
    }
