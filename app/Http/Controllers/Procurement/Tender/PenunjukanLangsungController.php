...
class PenunjukanLangsungController extends Controller
{
    ...
    public function create($paket_id)
    {
        ...
        $getTahapan         = \App\Models\Procurement\PaketTahapans::where('paket_id',Crypt::decrypt($paket_id))
                                ...
                                ->first();
        // dd($getTahapan);
        return view('procurement.penunjukanlangsungs.create',compact(
            'paket',
            'jadwal',
            'lembarKualifikasi',
            'getFileKak',
    ...
    public function editPengadaan($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.edit-pengadaan',compact('paket','jenisPengadaan','mtd_kualifikasi_id','evaluasiKriteria'))->withTitle('Tender Edit Pengadaan');
    }
    ...
    public function createJadwalPenunjukan($paket_id)
    {
        ...
        $paketTahaps = Tahaps::where('type',Tahaps::NonTender)
            ...
            ->get();
        // dd($paketTahaps);
        return view('procurement.penunjukanlangsungs.create-jadwal',compact('paket','paketTahaps'))->withTitle('Jadwal Non Tender');
    }
    ...
    public function createDokumenPenawaran($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-dokumen-penawaran',compact('paket','dokPenawaran'))->withTitle('Dokumen Penawaran');
    }
    ...
    public function createKualifikasi($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-kualifikasi',compact('paket','mkualfikasi'))->withTitle('Dokumen Penawaran');
    }
    ...
    */
    public function createDokPemilihan($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-dok-pemilihan',compact('paket'))->withTitle('Upload dokumen pemilihan');
    }
    ...
    */
    public function createRekanan($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-rekanan',compact('paket','rekanan'))->withTitle('Pilih Rekanan');
    }
    ...
    public function createEvaluasi($paket_id, $rekanan_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-evaluasi',compact('paket','rekanan','paketDok','paketKualifikasi'))->withTitle('Evaluasi');
    }
    ...
    public function createPemenang($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-pemenang',compact('paket','rekanan'))->withTitle('Penetapan Pemenang');
    }
    ...
    public function createNegoisasi($paket_id)
    {
        ...
        return view('procurement.penunjukanlangsungs.create-negoisasi',compact('paket','paketHps'))->withTitle('Input negoisasi');
    }
    ...
    public function storeKualifikasi(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('penunjukan-langsung.create-penunjukan',Crypt::encrypt($request->paket_id));
