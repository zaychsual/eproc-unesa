...
class RekananPenawaranNonTenderController extends Controller
{
    const Active = 1;
    const Submit = 1;
    ...
    public function inputPenawaran($id)
    {
        ...
        return view('procurement.rekananpenawaran.nontender.input-penawaran', compact('paket','paketHps','paketDokPenawran'))->withTitle('input penawaran Paket');
    }
    ...
    public function show($id)
    {
        ...
        return view('procurement.rekananpenawaran.nontender.show', compact(
            'paket',
            // 'paketDokPemilihan',
            'paketJadwal',
            'isSubmit',
    ...
    public function kirimPenawaran($paket_id)
    {
        ...
        return view('procurement.rekananpenawaran.nontender.kirim-penawaran-pl',compact('paket','paketHps'))->withTitle('Informasi Paket');
    }
     ...
     * @param array $request
     */
    public function kirimPenawaranPbb($paket_id)
    {
        $paket = Pakets::find(Crypt::decrypt($paket_id));
        $paketHps = \App\Models\Procurement\PaketDetailHps::where('paket_id', Crypt::decrypt($paket_id))->get();
        
        return view('procurement.rekananpenawaran.nontender.kirim-penawaran-pbb',compact('paket','paketHps'))->withTitle('Informasi Paket');
    }
    ...
    public function storeDatapenawaran(Request $request) 
    {
        ...
        return redirect()->route('laman-nontender.show',$request->paket_id);
    }

    public function storeDataPenawaranPl(Request $request) 
    {
    ...
    public function storeDataPenawaranPbb(Request $request)
    {
        $filePenawaran    = '';
        if( $request->has('file_penawaran')) {
            $file = $request->file('file_penawaran');
        ...
        return redirect()->route('laman-nontender.kirim-penawaran-pbb',Crypt::encrypt($request->paket_id));
    }
} 